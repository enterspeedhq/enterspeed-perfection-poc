...
export default function TopNav({ nav }) {
  ...
  return (
    <Box as="header" pos="sticky" top="0" zIndex="1">
      <Flex
  ...
  return (
    <Stack spacing={4} onClick={children && onToggle}>
      ...
      >
        ...
        {children && children?.length > 0 && <Icon as={ChevronDownIcon} transition={"all .25s ease-in-out"} transform={isOpen ? "rotate(180deg)" : ""} w={6} h={6} />}
      </Flex>
